...
# source: tensorboardX/proto/plugin_hparams_api.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboardX/proto/plugin_hparams_api.proto',
  package='tensorboardX.hparams',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=_b('\n+tensorboardX/proto/plugin_hparams_api.proto\x12\x14tensorboardX.hparams\x1a\x1cgoogle/protobuf/struct.proto\"\xc8\x01\n\nExperiment\x12\x0c\n\x04name\x18\x06 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x01 \x01(\t\x12\x0c\n\x04user\x18\x02 \x01(\t\x12\x19\n\x11time_created_secs\x18\x03 \x01(\x01\x12\x36\n\x0chparam_infos\x18\x04 \x03(\x0b\x32 .tensorboardX.hparams.HParamInfo\x12\x36\n\x0cmetric_infos\x18\x05 \x03(\x0b\x32 .tensorboardX.hparams.MetricInfo\"\xef\x01\n\nHParamInfo\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x14\n\x0c\x64isplay_name\x18\x02 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x03 \x01(\t\x12,\n\x04type\x18\x04 \x01(\x0e\x32\x1e.tensorboardX.hparams.DataType\x12\x35\n\x0f\x64omain_discrete\x18\x05 \x01(\x0b\x32\x1a.google.protobuf.ListValueH\x00\x12\x39\n\x0f\x64omain_interval\x18\x06 \x01(\x0b\x32\x1e.tensorboardX.hparams.IntervalH\x00\x42\x08\n\x06\x64omain\"0\n\x08Interval\x12\x11\n\tmin_value\x18\x01 \x01(\x01\x12\x11\n\tmax_value\x18\x02 \x01(\x01\"(\n\nMetricName\x12\r\n\x05group\x18\x01 \x01(\t\x12\x0b\n\x03tag\x18\x02 \x01(\t\"\xa0\x01\n\nMetricInfo\x12.\n\x04name\x18\x01 \x01(\x0b\x32 .tensorboardX.hparams.MetricName\x12\x14\n\x0c\x64isplay_name\x18\x03 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x04 \x01(\t\x12\x37\n\x0c\x64\x61taset_type\x18\x05 \x01(\x0e\x32!.tensorboardX.hparams.DatasetType\"\xa6\x02\n\x0cSessionGroup\x12\x0c\n\x04name\x18\x01 \x01(\t\x12@\n\x07hparams\x18\x02 \x03(\x0b\x32/.tensorboardX.hparams.SessionGroup.HparamsEntry\x12\x38\n\rmetric_values\x18\x03 \x03(\x0b\x32!.tensorboardX.hparams.MetricValue\x12/\n\x08sessions\x18\x04 \x03(\x0b\x32\x1d.tensorboardX.hparams.Session\x12\x13\n\x0bmonitor_url\x18\x05 \x01(\t\x1a\x46\n\x0cHparamsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12%\n\x05value\x18\x02 \x01(\x0b\x32\x16.google.protobuf.Value:\x02\x38\x01\"{\n\x0bMetricValue\x12.\n\x04name\x18\x01 \x01(\x0b\x32 .tensorboardX.hparams.MetricName\x12\r\n\x05value\x18\x02 \x01(\x01\x12\x15\n\rtraining_step\x18\x03 \x01(\x05\x12\x16\n\x0ewall_time_secs\x18\x04 \x01(\x01\"\xd7\x01\n\x07Session\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x17\n\x0fstart_time_secs\x18\x02 \x01(\x01\x12\x15\n\rend_time_secs\x18\x03 \x01(\x01\x12,\n\x06status\x18\x04 \x01(\x0e\x32\x1c.tensorboardX.hparams.Status\x12\x11\n\tmodel_uri\x18\x05 \x01(\t\x12\x38\n\rmetric_values\x18\x06 \x03(\x0b\x32!.tensorboardX.hparams.MetricValue\x12\x13\n\x0bmonitor_url\x18\x07 \x01(\t\"/\n\x14GetExperimentRequest\x12\x17\n\x0f\x65xperiment_name\x18\x01 \x01(\t\"\xc8\x02\n\x18ListSessionGroupsRequest\x12\x17\n\x0f\x65xperiment_name\x18\x06 \x01(\t\x12\x36\n\x10\x61llowed_statuses\x18\x07 \x03(\x0e\x32\x1c.tensorboardX.hparams.Status\x12\x33\n\ncol_params\x18\x01 \x03(\x0b\x32\x1f.tensorboardX.hparams.ColParams\x12?\n\x10\x61ggregation_type\x18\x02 \x01(\x0e\x32%.tensorboardX.hparams.AggregationType\x12<\n\x12\x61ggregation_metric\x18\x03 \x01(\x0b\x32 .tensorboardX.hparams.MetricName\x12\x13\n\x0bstart_index\x18\x04 \x01(\x05\x12\x12\n\nslice_size\x18\x05 \x01(\x05\"\xdc\x02\n\tColParams\x12\x32\n\x06metric\x18\x01 \x01(\x0b\x32 .tensorboardX.hparams.MetricNameH\x00\x12\x10\n\x06hparam\x18\x02 \x01(\tH\x00\x12.\n\x05order\x18\x03 \x01(\x0e\x32\x1f.tensorboardX.hparams.SortOrder\x12\x1c\n\x14missing_values_first\x18\x04 \x01(\x08\x12\x17\n\rfilter_regexp\x18\x05 \x01(\tH\x01\x12\x39\n\x0f\x66ilter_interval\x18\x06 \x01(\x0b\x32\x1e.tensorboardX.hparams.IntervalH\x01\x12\x35\n\x0f\x66ilter_discrete\x18\x07 \x01(\x0b\x32\x1a.google.protobuf.ListValueH\x01\x12\x1e\n\x16\x65xclude_missing_values\x18\x08 \x01(\x08\x42\x06\n\x04nameB\x08\n\x06\x66ilter\"k\n\x19ListSessionGroupsResponse\x12:\n\x0esession_groups\x18\x01 \x03(\x0b\x32\".tensorboardX.hparams.SessionGroup\x12\x12\n\ntotal_size\x18\x03 \x01(\x05\"~\n\x16ListMetricEvalsRequest\x12\x17\n\x0f\x65xperiment_name\x18\x03 \x01(\t\x12\x14\n\x0csession_name\x18\x01 \x01(\t\x12\x35\n\x0bmetric_name\x18\x02 \x01(\x0b\x32 .tensorboardX.hparams.MetricName*`\n\x08\x44\x61taType\x12\x13\n\x0f\x44\x41TA_TYPE_UNSET\x10\x00\x12\x14\n\x10\x44\x41TA_TYPE_STRING\x10\x01\x12\x12\n\x0e\x44\x41TA_TYPE_BOOL\x10\x02\x12\x15\n\x11\x44\x41TA_TYPE_FLOAT64\x10\x03*P\n\x0b\x44\x61tasetType\x12\x13\n\x0f\x44\x41TASET_UNKNOWN\x10\x00\x12\x14\n\x10\x44\x41TASET_TRAINING\x10\x01\x12\x16\n\x12\x44\x41TASET_VALIDATION\x10\x02*X\n\x06Status\x12\x12\n\x0eSTATUS_UNKNOWN\x10\x00\x12\x12\n\x0eSTATUS_SUCCESS\x10\x01\x12\x12\n\x0eSTATUS_FAILURE\x10\x02\x12\x12\n\x0eSTATUS_RUNNING\x10\x03*A\n\tSortOrder\x12\x15\n\x11ORDER_UNSPECIFIED\x10\x00\x12\r\n\tORDER_ASC\x10\x01\x12\x0e\n\nORDER_DESC\x10\x02*\x7f\n\x0f\x41ggregationType\x12\x15\n\x11\x41GGREGATION_UNSET\x10\x00\x12\x13\n\x0f\x41GGREGATION_AVG\x10\x01\x12\x16\n\x12\x41GGREGATION_MEDIAN\x10\x02\x12\x13\n\x0f\x41GGREGATION_MIN\x10\x03\x12\x13\n\x0f\x41GGREGATION_MAX\x10\x04\x62\x06proto3')
  ,
  dependencies=[google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,])

_DATATYPE = _descriptor.EnumDescriptor(
  name='DataType',
  full_name='tensorboardX.hparams.DataType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DATASETTYPE = _descriptor.EnumDescriptor(
  name='DatasetType',
  full_name='tensorboardX.hparams.DatasetType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_STATUS = _descriptor.EnumDescriptor(
  name='Status',
  full_name='tensorboardX.hparams.Status',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_SORTORDER = _descriptor.EnumDescriptor(
  name='SortOrder',
  full_name='tensorboardX.hparams.SortOrder',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_AGGREGATIONTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='tensorboardX.hparams.AggregationType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EXPERIMENT = _descriptor.Descriptor(
  name='Experiment',
  full_name='tensorboardX.hparams.Experiment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.Experiment.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='tensorboardX.hparams.Experiment.description', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user', full_name='tensorboardX.hparams.Experiment.user', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_created_secs', full_name='tensorboardX.hparams.Experiment.time_created_secs', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hparam_infos', full_name='tensorboardX.hparams.Experiment.hparam_infos', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_infos', full_name='tensorboardX.hparams.Experiment.metric_infos', index=5,
...
_HPARAMINFO = _descriptor.Descriptor(
  name='HParamInfo',
  full_name='tensorboardX.hparams.HParamInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.HParamInfo.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='tensorboardX.hparams.HParamInfo.display_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='tensorboardX.hparams.HParamInfo.description', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='tensorboardX.hparams.HParamInfo.type', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='domain_discrete', full_name='tensorboardX.hparams.HParamInfo.domain_discrete', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='domain_interval', full_name='tensorboardX.hparams.HParamInfo.domain_interval', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='domain', full_name='tensorboardX.hparams.HParamInfo.domain',
...
_INTERVAL = _descriptor.Descriptor(
  name='Interval',
  full_name='tensorboardX.hparams.Interval',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_value', full_name='tensorboardX.hparams.Interval.min_value', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_value', full_name='tensorboardX.hparams.Interval.max_value', index=1,
...
_METRICNAME = _descriptor.Descriptor(
  name='MetricName',
  full_name='tensorboardX.hparams.MetricName',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='group', full_name='tensorboardX.hparams.MetricName.group', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tag', full_name='tensorboardX.hparams.MetricName.tag', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METRICINFO = _descriptor.Descriptor(
  name='MetricInfo',
  full_name='tensorboardX.hparams.MetricInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.MetricInfo.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='tensorboardX.hparams.MetricInfo.display_name', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='tensorboardX.hparams.MetricInfo.description', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dataset_type', full_name='tensorboardX.hparams.MetricInfo.dataset_type', index=3,
...
_SESSIONGROUP_HPARAMSENTRY = _descriptor.Descriptor(
  name='HparamsEntry',
  full_name='tensorboardX.hparams.SessionGroup.HparamsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tensorboardX.hparams.SessionGroup.HparamsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='tensorboardX.hparams.SessionGroup.HparamsEntry.value', index=1,
...
_SESSIONGROUP = _descriptor.Descriptor(
  name='SessionGroup',
  full_name='tensorboardX.hparams.SessionGroup',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.SessionGroup.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hparams', full_name='tensorboardX.hparams.SessionGroup.hparams', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_values', full_name='tensorboardX.hparams.SessionGroup.metric_values', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sessions', full_name='tensorboardX.hparams.SessionGroup.sessions', index=3,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='monitor_url', full_name='tensorboardX.hparams.SessionGroup.monitor_url', index=4,
...
_METRICVALUE = _descriptor.Descriptor(
  name='MetricValue',
  full_name='tensorboardX.hparams.MetricValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.MetricValue.name', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='tensorboardX.hparams.MetricValue.value', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='training_step', full_name='tensorboardX.hparams.MetricValue.training_step', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wall_time_secs', full_name='tensorboardX.hparams.MetricValue.wall_time_secs', index=3,
...
_SESSION = _descriptor.Descriptor(
  name='Session',
  full_name='tensorboardX.hparams.Session',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorboardX.hparams.Session.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time_secs', full_name='tensorboardX.hparams.Session.start_time_secs', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time_secs', full_name='tensorboardX.hparams.Session.end_time_secs', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='tensorboardX.hparams.Session.status', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_uri', full_name='tensorboardX.hparams.Session.model_uri', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_values', full_name='tensorboardX.hparams.Session.metric_values', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='monitor_url', full_name='tensorboardX.hparams.Session.monitor_url', index=6,
...
_GETEXPERIMENTREQUEST = _descriptor.Descriptor(
  ...
  full_name='tensorboardX.hparams.GetExperimentRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_name', full_name='tensorboardX.hparams.GetExperimentRequest.experiment_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTSESSIONGROUPSREQUEST = _descriptor.Descriptor(
  ...
  full_name='tensorboardX.hparams.ListSessionGroupsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_name', full_name='tensorboardX.hparams.ListSessionGroupsRequest.experiment_name', index=0,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allowed_statuses', full_name='tensorboardX.hparams.ListSessionGroupsRequest.allowed_statuses', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='col_params', full_name='tensorboardX.hparams.ListSessionGroupsRequest.col_params', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='aggregation_type', full_name='tensorboardX.hparams.ListSessionGroupsRequest.aggregation_type', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='aggregation_metric', full_name='tensorboardX.hparams.ListSessionGroupsRequest.aggregation_metric', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_index', full_name='tensorboardX.hparams.ListSessionGroupsRequest.start_index', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='slice_size', full_name='tensorboardX.hparams.ListSessionGroupsRequest.slice_size', index=6,
...
_COLPARAMS = _descriptor.Descriptor(
  name='ColParams',
  full_name='tensorboardX.hparams.ColParams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='metric', full_name='tensorboardX.hparams.ColParams.metric', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hparam', full_name='tensorboardX.hparams.ColParams.hparam', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='order', full_name='tensorboardX.hparams.ColParams.order', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='missing_values_first', full_name='tensorboardX.hparams.ColParams.missing_values_first', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filter_regexp', full_name='tensorboardX.hparams.ColParams.filter_regexp', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filter_interval', full_name='tensorboardX.hparams.ColParams.filter_interval', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filter_discrete', full_name='tensorboardX.hparams.ColParams.filter_discrete', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exclude_missing_values', full_name='tensorboardX.hparams.ColParams.exclude_missing_values', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='name', full_name='tensorboardX.hparams.ColParams.name',
      index=0, containing_type=None, fields=[]),
    _descriptor.OneofDescriptor(
      name='filter', full_name='tensorboardX.hparams.ColParams.filter',
...
_LISTSESSIONGROUPSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='tensorboardX.hparams.ListSessionGroupsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='session_groups', full_name='tensorboardX.hparams.ListSessionGroupsResponse.session_groups', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_size', full_name='tensorboardX.hparams.ListSessionGroupsResponse.total_size', index=1,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTMETRICEVALSREQUEST = _descriptor.Descriptor(
  ...
  full_name='tensorboardX.hparams.ListMetricEvalsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_name', full_name='tensorboardX.hparams.ListMetricEvalsRequest.experiment_name', index=0,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='session_name', full_name='tensorboardX.hparams.ListMetricEvalsRequest.session_name', index=1,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_name', full_name='tensorboardX.hparams.ListMetricEvalsRequest.metric_name', index=2,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Experiment = _reflection.GeneratedProtocolMessageType('Experiment', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.Experiment)
  ))
...
HParamInfo = _reflection.GeneratedProtocolMessageType('HParamInfo', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.HParamInfo)
  ))
...
Interval = _reflection.GeneratedProtocolMessageType('Interval', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.Interval)
  ))
...
MetricName = _reflection.GeneratedProtocolMessageType('MetricName', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.MetricName)
  ))
...
MetricInfo = _reflection.GeneratedProtocolMessageType('MetricInfo', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.MetricInfo)
  ))
...
SessionGroup = _reflection.GeneratedProtocolMessageType('SessionGroup', (_message.Message,), dict(
  ...
  HparamsEntry = _reflection.GeneratedProtocolMessageType('HparamsEntry', (_message.Message,), dict(
    ...
    __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
    # @@protoc_insertion_point(class_scope:tensorboardX.hparams.SessionGroup.HparamsEntry)
    ))
  ,
  DESCRIPTOR = _SESSIONGROUP,
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.SessionGroup)
  ))
...
MetricValue = _reflection.GeneratedProtocolMessageType('MetricValue', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.MetricValue)
  ))
...
Session = _reflection.GeneratedProtocolMessageType('Session', (_message.Message,), dict(
  DESCRIPTOR = _SESSION,
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.Session)
  ))
...
GetExperimentRequest = _reflection.GeneratedProtocolMessageType('GetExperimentRequest', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.GetExperimentRequest)
  ))
...
ListSessionGroupsRequest = _reflection.GeneratedProtocolMessageType('ListSessionGroupsRequest', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.ListSessionGroupsRequest)
  ))
...
ColParams = _reflection.GeneratedProtocolMessageType('ColParams', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.ColParams)
  ))
...
ListSessionGroupsResponse = _reflection.GeneratedProtocolMessageType('ListSessionGroupsResponse', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.ListSessionGroupsResponse)
  ))
...
ListMetricEvalsRequest = _reflection.GeneratedProtocolMessageType('ListMetricEvalsRequest', (_message.Message,), dict(
  ...
  __module__ = 'tensorboardX.proto.plugin_hparams_api_pb2'
  # @@protoc_insertion_point(class_scope:tensorboardX.hparams.ListMetricEvalsRequest)
  ))
